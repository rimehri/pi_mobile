...
public class ServiceCategorief {
  ...
  public ArrayList<CategorieF> parseTasks(String jsonText){
        try {
            ...
            */
            ...
            for(Map<String,Object> obj : list){
             ...
             CategorieF t= new CategorieF();
                
              
                
               t.setNomC(obj.get("nomC").toString());
    ...
    public ArrayList<CategorieF> getAllTasks(){
        String url = "http://localhost/FINAL symfony/final/web/app_dev.php/ListMobile";
        req.setUrl(url);
        req.setPost(false);
